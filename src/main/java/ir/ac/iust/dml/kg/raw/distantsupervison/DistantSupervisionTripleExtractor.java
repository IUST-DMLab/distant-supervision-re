        ...
        for (List<ResolvedEntityToken> sentence : sentences) {
            ...
            while (s < sentence.size()) {
                ...
                if (sentence.get(s).getIobType().name().equalsIgnoreCase("Beginning") &&
                    ...
                    entityType.addAll(sentence.get(s).getResource().getClasses());
                    entity += sentence.get(s).getWord() + " ";
                    s++;
            ...
            for (int i = 0; i < entities.size(); i++) {
                for (int j = i + 1; j < entities.size(); j++) {
                    ...
                    CorpusEntryObject corpusEntryObject1 = prepareForTest(raw, subject1, subjectTypes1, object1, objectTypes1);
                    ...
                    CorpusEntryObject corpusEntryObject2 = prepareForTest(raw, subject2, subjectTypes2, object2, objectTypes2);
